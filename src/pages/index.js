          ...
          <div className="flex-container items-center h-screen">
            ...
            >
              <div className="text-box">
                ...
                <div className="sub-flex-box">
                  <div className="subtext-2">
                    Welcome to my personal website! I&apos;m a graduate student
                    at Purdue University studying Computer Science. I like
                    working on web-apps and DevOps systems. On this website, you
              ...
              <div className="social-container socials">
                <button
                  type="button"
                  class="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mb-2"
                  onClick={() => {
