            ...
            <div className="text-box">
              ...
              <div className="sub-flex-box">
                <div className="subtext-2">
                  ...
                  Purdue University studying Computer Science. I like working on
                  web-apps and DevOps systems. On this website, you can find my
                  social links, resume, and contact information.
                </div>
              </div>
              <a
