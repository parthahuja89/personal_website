...
export default function Home() {
  ...
  return (
    <header className="bg-nav">
      ...
      <nav className="nav mx-auto flex max-w-7xl items-center justify-end p-6 lg:px-8 nav-bar" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" className="leading-6 nav-bar-elem">
      ...
      <div className="w-1/2 h-2/3">
          ...
          Welcome to my personal website! I'm a developer with a focus on Back-End/DevOps. I'm passionate about building reliable and scalable software systems. On this website, you can learn more about my skills, experience, and projects, and get in touch to discuss potential collaborations.
          </div>
          <button className="px-4 py-2 border border-#02dbb7 text-#02dbb7 rounded-md hover:bg-#02dbb7 hover:text-white" style={{marginTop: '4%'}}>
            Contact Me
          </button>
    ...
    <div className="fixed bottom-0 right-0 flex flex-col p-4 space-y-3">
      <a href="#" className="text-sm font-semibold leading-6 text-gray-900 flex items-center" style={{ marginBottom: '10%' }}>
